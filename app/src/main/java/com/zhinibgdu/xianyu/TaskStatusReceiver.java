...
/** Persistent task logs, diagnostics, and daily completion history. */
public final class TaskStatusReceiver {
    ...
    /** Clear logs and diagnostic screenshots, preserving daily completion history. */
